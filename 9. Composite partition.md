...
CREATE TABLE stripe_regional_sales
  ...
  ```
  CREATE TABLE CANDYHIST_COMPPART(RESPONDENT_IDNUMBER,
SURVEY_DATEDATE,
LIKELIHOOD_PURCHASENUMBER,
...and so on...
NBR_BARS_CONSUMEDNUMBER)
PARTITION BY RANGE (SURVEY_DATE)
SUBPARTITIONBY LIST (LIKELIHOOD_PURCHASE)
SUBPARTITIONTEMPLATE (
SUBPARTITIONP_NOT_LIKELYVALUES(1,2,3),
SUBPARTITIONP_SOMEWHAT_LIKELYVALUES(4,5,6),
SUBPARTITIONP_VERY_LIKELYVALUES(7,8,9,10))
(
...
### AUTOTRACEand Partition-Wise Joins
